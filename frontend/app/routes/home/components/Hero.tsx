...
export default function Hero() {
    return (
        <div className={clsx("relative w-full min-h-screen overflow-hidden flex items-center justify-center",
            ...
            <div className={clsx("z-10 flex flex-row flex-wrap align-center justify-center gap-5",
                "sm:flex-row-reverse")}>
                <Logo />
                <h2 className="text-3xl md:text-5xl font-light tracking-wide self-center align-center text-center">
