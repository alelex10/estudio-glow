...
interface ButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
  ...
  className?: string;
  variant?: "primary" | "secondary" | "tertiary" | "outline" | "gold";
  size?: "lg" | "md" | "sm" | "none";
...
export const Button = ({
  ...
  const variants = {
    ...
    tertiary: "bg-primary-400 text-primary-100 hover:bg-primary-300",
    outline: clsx(
      "bg-transparent text-primary-900  hover:text-primary-700 hover:border-primary-700",
