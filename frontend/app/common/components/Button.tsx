...
export const Button = ({ children, className, variant = "primary", size = "md", rounded = "medium" }: ButtonProps) => {
    const variants = {
    ...
    return (
        <button className={clsx("w-full text-primary-900 font-medium hover:cursor-pointer transition-colors",
            roundedBtn[rounded],
            variants[variant],
            sizes[size],
            "active:scale-95",
